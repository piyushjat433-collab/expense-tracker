...
function generateDemoTransactions() {
  const demos = [
    ...
    { desc: 'Amazon Shopping', amount: 2999, type: 'debit', daysAgo: 2 },
    { desc: 'Salary Credit', amount: 45000, type: 'credit', daysAgo: 3 },
    { desc: 'Uber Ride', amount: 450, type: 'debit', daysAgo: 4 },
    ...
    { desc: 'Flipkart Purchase', amount: 1799, type: 'debit', daysAgo: 8 },
    { desc: 'Apollo Pharmacy', amount: 560, type: 'debit', daysAgo: 9 },
    { desc: 'IRCTC Train Ticket', amount: 1250, type: 'debit', daysAgo: 10 },
    { desc: 'Dominos Pizza', amount: 520, type: 'debit', daysAgo: 11 },
    { desc: 'Myntra Clothing', amount: 1499, type: 'debit', daysAgo: 12 },
    { desc: 'Udemy Course', amount: 499, type: 'debit', daysAgo: 13 },
    { desc: 'Starbucks Coffee', amount: 380, type: 'debit', daysAgo: 14 },
    { desc: 'OLA Cab', amount: 230, type: 'debit', daysAgo: 15 },
    { desc: 'Electricity Bill', amount: 1200, type: 'debit', daysAgo: 16 },
    { desc: 'BigBasket Grocery', amount: 1850, type: 'debit', daysAgo: 18 },
    { desc: 'PVR Cinema', amount: 680, type: 'debit', daysAgo: 19 },
    { desc: 'JIO Recharge', amount: 719, type: 'debit', daysAgo: 20 },
    { desc: 'MakeMyTrip Flight', amount: 5400, type: 'debit', daysAgo: 22 },
    { desc: 'Freelance Payment', amount: 12000, type: 'credit', daysAgo: 23 },
    { desc: 'Amazon Prime', amount: 1499, type: 'debit', daysAgo: 25 },
    { desc: 'Decathlon Sports', amount: 3200, type: 'debit', daysAgo: 26 },
    { desc: 'DMart Grocery', amount: 2300, type: 'debit', daysAgo: 29 },
